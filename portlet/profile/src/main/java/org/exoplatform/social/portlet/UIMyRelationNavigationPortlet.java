...
@ComponentConfig(
 ...
 template = "app:/groovy/portal/webui/component/UIMyRelationNavigationPortlet.gtmpl"
)
public class UIMyRelationNavigationPortlet extends UIPortletApplication {

  /**
   * Default Constructor.<br>
   * @throws Exception
   */
  public UIMyRelationNavigationPortlet() throws Exception { }
