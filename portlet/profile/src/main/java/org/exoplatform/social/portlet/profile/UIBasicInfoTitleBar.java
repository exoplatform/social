...
/**
 * Component is used for managing title bar of profile management section.<br>
 * 
 */

@ComponentConfig(
    template =  "app:/groovy/portal/webui/component/UIBasicInfoTitleBar.gtmpl"
)
public class UIBasicInfoTitleBar extends UIComponent {
