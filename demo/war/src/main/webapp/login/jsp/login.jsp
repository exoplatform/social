  ...
  <body style="text-align: center; background: #f5f5f5; font-family: arial, tahoma, verdana">
    <div class="UILogin">
      ...
      <div class="LoginContent">
        <div class="WelcomeText">Welcome to eXo Portal from "social-portal"</div>
    ...
    <span style="margin: 10px 0px 0px 5px; font-size: 11px; color: #6f6f6f; text-align: center">Copyright &copy 2010. All rights Reserved, eXo Platform SAS.</span>
  </body>
</html>