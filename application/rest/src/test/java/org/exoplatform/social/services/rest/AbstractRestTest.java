...
@ConfiguredBy({
  ...
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.social.application.rest.test.rest-configuration.xml")
})
public abstract class AbstractRestTest extends AbstractKernelTest {
  protected static Log log = ExoLogger.getLogger(AbstractRestTest.class.getName());
