...
public class ProfileConnector extends MailConnector {

  public ProfileConnector(InitParams initParams) {
    super(initParams);
  }

  @Override
  public Collection<EmailMessage> emails() {
    return SocialEmailUtils.getSocialEmailStorage().getEmailNotification(CONNECTOR_TYPE.PROFILE);
  }
