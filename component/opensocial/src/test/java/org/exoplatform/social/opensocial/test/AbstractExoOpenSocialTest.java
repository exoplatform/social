 ...
 */
package org.exoplatform.social.opensocial.test;
...
/**
 * AbstractOpenSocialTest.java
 *
 * @author  <a href="http://hoatle.net">hoatle</a>
 * @since   May 30, 2010 5:58:25 PM
 */
@ConfiguredBy({
  ...
  @ConfigurationUnit(scope = ContainerScope.PORTAL, path = "conf/standalone/exo.social.component.opensocial.test.configuration.xml")
})
public abstract class AbstractExoOpenSocialTest extends AbstractKernelTest {
