...
public class ActivityStreamResources implements ResourceContainer {
   ...
   * @request
   *{code}
   * GET: http://rest-socialdemo/private/api/social/v1-alpha3/socialdemo/activity_stream/f92cd6f0c0a80137102696ac26430766.json?limit=30&since_id=12345&number_of_likes=5
   *{code}
   * @response
   *{code:json}
   * {
   ...
   * @request
   *{code}
   * GET: http://rest-socialdemo/private/api/social/v1-alpha3/socialdemo/activity_stream/feedByTimestamp.json?limit=30&sinceTime=12345&number_of_comments=5&number_of_likes=5
   *{code}
   * @response
   *{code:json}
   * {
   ...
   * @request
   *{code}
   * GET: http://rest-socialdemo/private/api/social/v1-alpha3/socialdemo/activity_stream/spaces.json?limit=30&since_id=12345&number_of_comments=5&number_of_likes=5
   *{code}
   * @response
   *{code:json}
   * {
   ...
   * @request
   *{code}
   * GET: http://rest-socialdemo/private/api/social/v1-alpha3/socialdemo/activity_stream/connections.json?limit=30&sinceTime=12345&number_of_comments=5&number_of_likes=5
   *{code}
   * @response
   *{code:json}
   * {
