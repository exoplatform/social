  ...
  try {
    assertNotNull("space.getId() must not be null", space.getId());
     ...
     { // test case for grant or revoke manage role of users
       ...
       assertEquals("<a href=\"/portal/intranet/profile/demo\" rel=\"nofollow\" target=\"_blank\">Demo gtn</a> has been promoted as space&#39;s manager.", comments.get(1).getTitle());
       ...
       assertEquals("<a href=\"/portal/intranet/profile/demo\" rel=\"nofollow\" target=\"_blank\">Demo gtn</a> has been revoked as space&#39;s manager.", comments.get(2).getTitle());
