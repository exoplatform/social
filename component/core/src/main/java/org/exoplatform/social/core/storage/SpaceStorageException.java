...
public class SpaceStorageException extends ExoSocialException {
  ...
  public static enum Type {
    ...
    FAILED_TO_GET_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Spaces_With_Offset_Limit"),
    FAILED_TO_GET_SPACES_COUNT("Failed_To_Get_Spaces_Count"),
    FAILED_TO_GET_SPACES_BY_SEARCH_CONDITION_WITH_OFFSET_LIMIT("Failed_To_Get_Spaces_By_Search_Condition_With_Offset_Limit"),
    FAILED_TO_GET_SPACES_BY_SEARCH_CONDITION_COUNT("Failed_To_Get_Spaces_By_Search_Condition_Count"),
    FAILED_TO_GET_SPACES_BY_FIRST_CHARACTER_OF_NAME_WITH_OFFSET_LIMIT("Failed_To_Get_Spaces_By_First_Character_Of_Name_With_Offset_Limit"),
    FAILED_TO_GET_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Spaces_By_First_Character_Of_Name_Count"),
    FAILED_TO_GET_ACCESSIBLE_SPACES("Failed_To_Get_Accessible_Spaces"),
    FAILED_TO_GET_ACCESSIBLE_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Accessible_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_ACCESSIBLE_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Accessible_Spaces_By_First_Character_Of_Name"),
    FAILED_TO_GET_ACCESSIBLE_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Accessible_Spaces_By_First_Character_Of_Name_Count"),
    FAILED_TO_GET_EDITABLE_SPACES("Failed_To_Get_Editable_Spaces"),
    FAILED_TO_GET_EDITABLE_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Editable_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_EDITABLE_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Editable_Spaces_By_First_Character_Of_Name"),
    FAILED_TO_GET_EDITABLE_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Editable_Spaces_By_First_Character_Of_Name_Count"),
    FAILED_TO_GET_INVITED_SPACES("Failed_To_Get_Invited_Spaces"),
    FAILED_TO_GET_INVITED_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Invited_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_INVITED_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Invited_Spaces_By_First_Character_Of_Name"),
    FAILED_TO_GET_INVITED_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Invited_Spaces_By_First_Character_Of_Name_Count"),
    FAILED_TO_GET_PENDING_SPACES("Failed_To_Get_Pending_Spaces"),
    FAILED_TO_GET_PENDING_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Pending_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_PENDING_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Pending_Spaces_By_First_Character_Of_Name"),
    FAILED_TO_GET_PENDING_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Pending_Spaces_By_First_Character_Of_Name_Count"),
    ...
    FAILED_TO_GET_PUBLIC_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Public_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_PUBLIC_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Public_Spaces_By_First_Character_Of_Name"),
    FAILED_TO_GET_PUBLIC_SPACES_BY_FIRST_CHARACTER_OF_NAME_COUNT("Failed_To_Get_Public_Spaces_By_First_Character_Of_Name_Count"),
    FAILED_TO_GET_MEMBER_SPACES("Failed_To_Get_Member_Spaces"),
    FAILED_TO_GET_MEMBER_SPACES_BY_FIRST_CHARACTER_OF_SPACE_NAME("Failed_To_Get_Member_Spaces_By_First_Character_Of_Space_Name"),
    FAILED_TO_GET_MEMBER_SPACES_BY_FIRST_CHARACTER_OF_SPACE_NAME_COUNT("Failed_To_Get_Member_Spaces_By_First_Character_Of_Space_Name_Count"),
    FAILED_TO_GET_MEMBER_SPACES_BY_SPACE_NAME_SEARCH_CONDITION("Failed_To_Get_Member_Spaces_By_Space_Name_Search_Condition"),
    FAILED_TO_GET_MEMBER_SPACES_BY_SPACE_NAME_SEARCH_CONDITION_COUNT("Failed_To_Get_Member_Spaces_By_Space_Name_Search_Condition_Count"),
    FAILED_TO_GET_MEMBER_SPACES_WITH_OFFSET_LIMIT("Failed_To_Get_Member_Spaces_With_Offset_Limit"),
    ...
    FAILED_TO_GET_SPACES_BY_FIRST_CHARACTER_OF_NAME("Failed_To_Get_Spaces_By_First_Character_Of_Name"),
