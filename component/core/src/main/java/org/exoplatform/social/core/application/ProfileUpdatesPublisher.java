...
public class ProfileUpdatesPublisher extends ProfileListenerPlugin {
  ...
  public void avatarUpdated(ProfileLifeCycleEvent event) {
    publish(event, "@" + event.getUsername() + " has an updated profile picture.");
  }


  @Override
  public void basicInfoUpdated(ProfileLifeCycleEvent event) {
    publish(event, "@" + event.getUsername() + " has an updated basic profile info.");
  }

  @Override
  public void contactSectionUpdated(ProfileLifeCycleEvent event) {
   publish(event, "@" + event.getUsername() + " has an updated contact info.");

  }

  @Override
  public void experienceSectionUpdated(ProfileLifeCycleEvent event) {
    publish(event, "@" + event.getUsername() + " has an updated experience section.");
  }

  @Override
  public void headerSectionUpdated(ProfileLifeCycleEvent event) {
    publish(event, "@" + event.getUsername() + " has an updated header info.");
  }
  ...
  private void publish(ProfileLifeCycleEvent event, String message) {
    try {
      ...
      activityManager.saveActivity(identity,
