...
public class DefaultSpaceApplicationHandler implements SpaceApplicationHandler {
 ...
 /**
   ...
   * @return
   * @throws SpaceException
   * @deprecated Use {@link #createPageNodeFromApplication(org.exoplatform.social.core.space.model.Space, org.exoplatform.social.core.space.SpaceApplicationConfigPlugin.SpaceApplication, String, boolean)}
