 ...
 */
@ComponentConfig(
  template = "classpath:groovy/social/plugin/link/UIComposerExtensionContainer.gtmpl",
  events = {
...
public class UIComposerExtensionContainer extends UIContainer {
  ...
  public void setCurrentExtension(Extension extension) {
    ...
    if (extension == Extension.LINK) {
      getChild(UILinkActivityComposer.class).setRendered(true);
  ...
  private void init() throws Exception { 
    if (enabledExtensionList_.contains(Extension.LINK)) {
      addChild(UILinkActivityComposer.class, null, "UIComposerLinkExtension").setRendered(false);
    }
